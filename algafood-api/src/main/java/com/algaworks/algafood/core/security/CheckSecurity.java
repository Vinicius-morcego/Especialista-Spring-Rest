...
public @interface CheckSecurity {
	...
	public @interface Pedidos{
		...
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and hasAuthority('GERENCIAR_PEDIDOS') or "
				+ "@algaSecurity.gerenciaPedido(#codigoPedido)")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeGerenciaPedido{ }
	...
	public @interface UsuariosGruposPermissoes{
		...
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and @algaSecurity.podeAlterarPropriaSenha(#usuarioId)")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeAlterarPropriaSenha{ }
		
		@PreAuthorize("hasAuthority('SCOPE_WRITE') and (hasAuthority('EDITAR_USUARIOS_GRUPOS_PERMISSOES') or "
				+ "@algaSecurity.podeAlterarPropriaSenha(#usuarioId))")
		@Retention(RUNTIME)
		@Target(METHOD)
